...
public class PullToRefreshListView extends ListView implements AbsListView.OnScrollListener,
    ...
    private void init() {
     ...
     /*   arrowIv = (ImageView) headerView.findViewById(R.id.head_arrowImageView);
        ...
        progressLl = (LinearLayout) headerView.findViewById(R.id.head_progressBar);
    ...
    private void reset() {
       /* arrowLl.setVisibility(View.VISIBLE);
        ...
        tipsTv.setText(R.string.drop_down);
    ...
    private void releaseToRefresh() {
       /* arrowLl.setVisibility(View.VISIBLE);
        ...
        tipsTv.setText(R.string.release_update);
    ...
    private void refresh() {
      /*  progressLl.setVisibility(View.VISIBLE);
        ...
        tipsTv.setText(R.string.loading);
*/
        //如果上拉加载进行中，则取消下拉刷新
        if (isLoadingMore) {
            isRefreshing = false;
