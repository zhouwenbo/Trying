package com.fheebiy.trying.http.lite.apache;

import android.os.NetworkOnMainThreadException;
import com.fheebiy.trying.util.Log;
import com.fheebiy.trying.http.lite.LiteHttpClient;
import com.fheebiy.trying.http.lite.data.Charsets;
import com.fheebiy.trying.http.lite.data.Consts;
import com.fheebiy.trying.http.lite.data.HttpStatus;
import com.fheebiy.trying.http.lite.exception.HttpClientException;
import com.fheebiy.trying.http.lite.exception.HttpException;
import com.fheebiy.trying.http.lite.exception.HttpNetException;
import com.fheebiy.trying.http.lite.exception.HttpServerException;
import com.fheebiy.trying.http.lite.exception.HttpServerException.ServerException;
import com.fheebiy.trying.http.lite.listener.HttpListener;
import com.fheebiy.trying.http.lite.parser.DataParser;
import com.fheebiy.trying.http.lite.parser.StringParser;
import com.fheebiy.trying.http.lite.request.Request;
import com.fheebiy.trying.http.lite.request.content.HttpBody;
import com.fheebiy.trying.http.lite.request.param.HttpMethod;
import com.fheebiy.trying.http.lite.request.param.HttpParam;
import com.fheebiy.trying.http.lite.response.InternalResponse;
...
public class ApacheHttpClient extends LiteHttpClient {
    ...
    @Override
    public com.fheebiy.trying.http.lite.data.NameValuePair[] head(String uri) {
        ...
        while (retry) {
            try {
                ...
                if (!Thread.currentThread().isInterrupted()) {
                    ...
                    if (headers != null) {
                        com.fheebiy.trying.http.lite.data.NameValuePair hs[] = new com.fheebiy.trying.http.lite.data.NameValuePair[headers.length];
                        for (int i = 0; i < headers.length; i++) {
                            ...
                            hs[i] = new com.fheebiy.trying.http.lite.data.NameValuePair(name, value);
                        }
